...
function makeExternalMatcher(obj) {
	...
	// semgrep-ignore: detect-non-literal-regexp
	// Safe: Pattern validated for ReDoS using recheck library (https://www.npmjs.com/package/recheck)
	// and input sanitized via validateRegexSafety() and escapeRegExp()
